  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        ...
        {/* Main Heading */}
        <h1 className="animate-slide-up opacity-0 max-w-5xl text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-8" style={{ animationDelay: '0.2s' }}>
        ...
        {/* Subtitle */}
        <p className="animate-slide-up opacity-0 max-w-2xl text-lg md:text-xl text-gray-400 mb-10 leading-relaxed" style={{ animationDelay: '0.3s' }}>
        ...
        {/* CTA Buttons */}
        <div className="animate-slide-up opacity-0 flex flex-col sm:flex-row items-center gap-5 mb-16" style={{ animationDelay: '0.4s' }}>
          <a
            href="#services"
            className="group relative px-8 py-4 bg-primary text-primary-foreground font-bold text-lg rounded-xl overflow-hidden hover:shadow-[0_0_40px_-10px_rgba(255,193,7,0.5)] transition-shadow duration-300"
          >
          ...
          <a
            href="#about"
            className="px-8 py-4 bg-white/5 text-white font-medium text-lg rounded-xl border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300"
          >
            Learn More
          </a>
        </div>
        ...
        <div className="animate-slide-up opacity-0 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-16 pt-8 border-t border-white/10 w-full max-w-5xl" style={{ animationDelay: '0.6s' }}>
          {[
